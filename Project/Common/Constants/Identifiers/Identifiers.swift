...
struct Storyboard {
    ...
    let SignInMobileViewController = "SignInMobileViewController"
    ...
    let CreateHealthFeedViewController = "CreateHealthFeedViewController"
    let ProfieViewController = "ProfieViewController"
    let EditProfileTableViewController = "EditProfileTableViewController"
